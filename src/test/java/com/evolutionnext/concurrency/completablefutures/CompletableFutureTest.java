...
public class CompletableFutureTest {
    ...
    public void completableFutureWithThenApply() throws InterruptedException {
        integerFuture1.thenApply(x -> {
            ...
            System.out.println("In this section: " + Thread.currentThread().getName());
    ...
    public void completableFutureWithThenApplyAsync() throws InterruptedException {
        ...
        integerFuture1.thenApplyAsync(x1 -> {
            System.out.println("In the thenApplyAsync:" +
                Thread.currentThread().getName());
            return "" + (x1 + 19);
        }).thenAcceptAsync((x) -> {
            System.out.println("In the thenAcceptAsync:" + Thread.currentThread().getName());
    ...
    @Test
    public void completableComposeCleanedUp() throws InterruptedException {
        stringFuture1
            .thenCompose(this::getTemperatureInFahrenheit)
            .thenAccept(System.out::println);
        Thread.sleep(6000);
    }
