package com.evolutionnext.concurrency.httpclient;
...
public class HttpClientTest {
    ...
    void testSimpleAsyncGetJson() throws InterruptedException {
        try (HttpClient client = HttpClient.newHttpClient()) {
            ...
            client
                ...
                .handle((s, throwable) -> handleOrLogError(s, throwable, "Error Occurred"))
                .thenAccept(System.out::println)
                .get();
    ...
    private static String handleOrLogError(String s, Throwable throwable, String errorMessage) {
        if (s != null) return s;
        else {
