...
public class FutureBasicsTest {
    ...
    @Test
    void testFutureIsEager() throws InterruptedException, ExecutionException {
        ExecutorService executorService = Executors.newFixedThreadPool(10);
        Future<Integer> future = executorService.submit(() -> {
            System.out.println("Doing a computation");
            return 3000;
        });
        Thread.sleep(5000);
    ...
    public Future<Integer> makeItLazyAsAMethod() {
        ExecutorService executorService = Executors.newFixedThreadPool(10);
    ...
    @Test
    void testParameterizeAFuture() throws ExecutionException, InterruptedException {
        int value = 10;
        ExecutorService executorService = Executors.newFixedThreadPool(10);
        Future<Integer> future = executorService.submit(() -> value + 400);
        System.out.println(future.get());
    }

    public Future<Integer> addToThisNumber(int value) {
        ExecutorService executorService = Executors.newFixedThreadPool(10);
        Future<Integer> future = executorService.submit(() -> value + 400);
        return future;
    }
